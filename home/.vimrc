" This .vimrc is based off Gary Bernhardt's .vimrc
" His .vimrc is located at:
" https://github.com/garybernhardt/dotfiles/tree/master/.vimrc
"
" vim:set ts=4 sts=4 sw=4 expandtab:

let g:pathogen_disabled=[]
let g:use_py_powerline='False'
if v:version > 703 || (v:version == 703 && has("patch661"))
...
let g:Tex_CompileRule_pdf = 'pdflatex -interaction=nonstopmode -shell-escape -8bit $*'
